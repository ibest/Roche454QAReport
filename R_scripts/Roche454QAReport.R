source("QualityAssessmentof454.R")
source("QualFilterMetrics.R") 
library(ShortRead)
library(xtable)
library(Biobase)
...
Roche454QAReport <- function(directory, output = "pdf",
...
#   texTemp = "/mnt/home/zev/454QaReport/trunk/R_scripts/roche454QATemplate.tex"
   ...
   symVals = c( repName=gsub("_","-",repName), numRegions=nReg,  
TABLE1=TAB1, 
